...
const Footer = () => {
  ...
  return (
    <div className="pos-relative flex-center flex-col align-center  bottom-0 ">
      <img
        ...
        >
          ...
          >
            ...
            <Bolt
              ...
              fontSize="large"
            />
            <Link to={'/about'} component={RouteLink} sx={{display: { xs: "none", sm: "block" }}}>
            <Button
              className="font-modesto-condensed btn-text"
              sx={{
                mt: { xs: -7, sm: 0 },
            ...
            <Bolt
              ...
              fontSize="large"
            />
            <Link to='/the-artists' component={RouteLink} sx={{display: { xs: "none", sm: "block" }}}>
            <Button
              className="font-modesto-condensed btn-text"
              sx={{
                mt: { xs: -7, sm: 0 },
            ...
            <Bolt
              ...
              fontSize="large"
            />
            <Link to='/tickets' component={RouteLink} sx={{display: { xs: "none", sm: "block" }}} >
            <Button
              className="font-modesto-condensed btn-text"
              sx={{
                mt: { xs: -7, sm: 0 },
            ...
            <Bolt
              ...
              fontSize="large"
            />
            <Link to='faq' component={RouteLink} sx={{display: { xs: "none", sm: "block" }}}>
            <Button
              className="font-modesto-condensed btn-text"
              sx={{
                mt: { xs: -7, sm: 0 },
          ...
          <img src={BMSLiveSvg} className="rotate live-logo footerBGImg" alt="img" />
          <Box sx={{ mt: { xs: 0, sm: 2 } }}>
            <Typography
              variant="caption"
